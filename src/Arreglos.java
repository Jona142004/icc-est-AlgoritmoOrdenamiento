...
public class Arreglos {
    ...
    public int[] generarArreglo100(int[] arreglo10){
        ...
        for (int i = 10; i < 100; i++) {
            arreglo100[i] = rand.nextInt(100) + 1;
        }
        return arreglo100;
    }
    ...
    public int[] generarArreglo1000(int[] arreglo100){
        ...
        for (int i = 100; i < 1000; i++) {
            arreglo1000[i] = rand.nextInt(1000) + 1;
        }
        return arreglo1000;
    }
    ...
    public int[] generarArreglo5000(int[] arreglo1000){
        ...
        for (int i = 1000; i < 5000; i++) {
            arreglo5000[i] = rand.nextInt(5000) + 1;
        }
        return arreglo5000;
    }
    ...
    public int[] generarArreglo10000(int[] arreglo5000){
        ...
        for (int i = 5000; i < 10000; i++) {
            arreglo10000[i] = rand.nextInt(10000) + 1;
        }
        return arreglo10000;
    }
